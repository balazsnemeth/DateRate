window.CodiqaControls = {types: {}, instances: {}, define: function (a, b) {
    b._type = a;
    this.types[a] = b
...
CodiqaControls.GoogleMap.prototype.initType = function () {
    if (window.CodiqaControls.getInstances("googlemaps").length)if (this._isInited)window.google && window.google.maps && CodiqaControls.GoogleMap.prototype.callbackInit(); else {
...
(function (a) {
    a.widget("mobile.tabbar", a.mobile.navbar, {_create: function () {
