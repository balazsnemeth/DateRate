...
//		this.deSelectAll();
        ...
        /**
         * Animate on mobile, when the touch is just started, the size of the star will be stretch for double size.
         */
        ...
        /**
         * Main function. It is resposible to add the stars to an HTML DOM element. It set up the requred images (placeholders, selected stars) , events and classes.
         *
         */
        ...
        /** A callback before a star is selected. Optional. */
        this.beforeStarClick = null;
        /** A callback after a star is selected. Optional. */
